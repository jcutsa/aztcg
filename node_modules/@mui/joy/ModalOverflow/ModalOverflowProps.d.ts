...
export type ModalOverflowSlotsAndSlotProps = CreateSlotsAndSlotProps<ModalOverflowSlots, {
...
export type ModalOverflowProps<D extends React.ElementType = ModalOverflowTypeMap['defaultComponent'], P = {
